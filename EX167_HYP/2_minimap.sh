...
run_minimap2(){
  ...
  if [ -f $2/${name}_sorted.sam ]; then
    ...
    htsbox samview -pS $2/${name}_filtered_sorted.sam > $2/${name}.paf
...
inputDir=/lustre/projects/Research_Project-MRC190311/longReadSeq/ONTRNA/Gina/analysis/EX167_Hypo/6_blaze
mkdir -p ${inputDir}/2_minimap
run_minimap2 ${inputDir}/1_blaze/EX167_HYPmatched_reads_trimmed.fastq ${inputDir}/2_minimap
